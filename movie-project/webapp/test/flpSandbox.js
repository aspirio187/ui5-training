		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Movie Project",
									"targetURL": "#movieproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"movieproject-display": {
								"semanticObject": "movieproject",
								"action": "display",
								"description": "A simple poc to retrieve some data",
								"title": "Movie Project",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=movieproject",
									"url": sap.ui.require.toUrl("movieproject")
								}
							}
						}
					}
