			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"quickstart-display": {
								"semanticObject": "quickstart",
								"action": "display",
								"description": "Learning ui5-training",
								"title": "Quickstart",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=quickstart",
									"url": sap.ui.require.toUrl("quickstart")
								}
							}
						}
					}
